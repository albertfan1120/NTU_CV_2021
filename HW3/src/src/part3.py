...
if __name__ == '__main__':
    ...
    target = np.array([[0, 0], [w, 0], [w, h], [0, h]])
    
    H_1 = solve_homography(corners1, target)
    output3_1 = warping(secret1, dst, H_1, 0, h, 0, w)
    
    H_2 = solve_homography(corners2, target)
    output3_2 = warping(secret2, dst, H_2, 0, h, 0, w)
